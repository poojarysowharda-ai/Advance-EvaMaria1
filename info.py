...
API_ID = int(environ.get('API_ID', '36512185'))
API_HASH = environ.get('API_HASH', '085d4274aee14865ddde9ec41e34185e')
BOT_TOKEN = environ.get('BOT_TOKEN', "8535802468:AAEhSLfV0hpMY15mneiTFL_CYIiYnEmSy3A")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5835489940').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sowharda:<db_Sow22>@cluster0.hmald4l.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster 0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1003809112222'))
